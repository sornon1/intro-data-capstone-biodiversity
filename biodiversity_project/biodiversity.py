...
category_pivot['percent_protected'] = 100*category_pivot.protected/(category_pivot.not_protected + category_pivot.protected*1.0)
...
rep_contingency = [[5,73],[30,146]]
chi2, pval,dof,expected = chi2_contingency(rep_contingency)
print(pval)
...
weeks_at_bryce = sample_size/(obs_by_park[obs_by_park.park_name == 'Bryce National Park'].observations)
weeks_at_yellowstone = sample_size/(obs_by_park[obs_by_park.park_name == 'Yellowstone National Park'].observations)

print('Bryce:' + str(weeks_at_bryce))
print('Yellowstone:' + str(weeks_at_yellowstone))
